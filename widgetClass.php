...
class Widget_AllWebMenus extends WP_Widget
{
	...
	<?php else: ?>
		<p><strong style="color: red">Warning!!!</strong><br/>It seems that you chose the AllWebMenus menu widget from the <em>'Available
				Widgets'</em> panel. Instead, you should drag and drop the related AllWebMenus menu widget from the <em>'Inactive
				Widgets'</em> panel. If you cannot find the widget that you want, go to <a
				href="<?php echo admin_url('options-general.php?page=allwebmenus-wordpress-menu-plugin/allwebmenus-wordpress-menu.php') ?>">AllWebMenus
				settings</a>, select the tab of the menu that you want and choose the "Widget" value in the "Menu Positioning Method"
			property.</p>
	<?php endif; ?>
		<?php
	}
